...
_add_softs_common()
{
    ...
    add_soft linux-lts linux-lts-headers
    #add_soft mesa-demos
    add_soft libvdpau-va-gl
    add_soft libva-intel-driver
    add_soft libva-vdpau-driver
    ...
    #add_soft pulseaudio-bluetooth bluez-utils bluez
    ...
    add_soft dnsutils
    add_soft traceroute mtr httpie
    add_soft openbsd-netcat
    # add_soft namebench 
    add_soft proxychains-ng
    ...
    # add_soft flawfinder locate cutils icheck cccc cproto
    # add_soft cppcheck 
    # add_soft mtd-utils 
    ...
    add_soft xfsprogs dmraid parted #jfsutils
    #add_soft gparted 
    ...
    #add_soft tk
    add_soft python 
    #add_soft python-docs
    #add_soft python-pytest
    ...
    #add_soft python-pyotp #for google auth

    #add_soft python-openpyxl
    #add_soft python-sqlalchemy 
    #add_soft python-redis
    #add_soft python-pymongo
    #add_soft python-mysql-connector 

    #add_soft python-pyperclip #python clipboard
    #add_soft python-tqdm

    #for math and machine learning
    #add_soft python-pandas python-numexpr python-pandas-datareader python-bottleneck
    #add_soft python-xlrd #for pandas xlsx read
    #add_soft python-scipy python-matplotlib python-numpy
    #add_soft tensorflow python-tensorflow python-seaborn python-scikit-learn

    #add_soft geckodriver
    ...
    #add_soft mtpfs gvfs-mtp gvfs-afc gvfs-smb gvfs-gphoto2
...
_add_softs_gui()
{
    echo "gui"
    # add_soft rapidsvn
    # add_soft kdesvn #use idea svn plugin
    ...
    #add_soft fcitx-gtk2 fcitx-gtk3 fcitx-qt5 #fcitx-qt4 
    # add_soft ibus-gtk ibus-gtk3 ibus-qt4 sunpinyin-data ibus-sunpinyin

    # add_soft synaptic

    # add_soft lxde-gtk3
    #add_soft lxqt compton lxdm
    #add_soft sddm
...
_setup_service()
{
    ...
    $SUDO systemctl disable nmbd || true
...
_setup_network()
{
    ...
    if [ -e /etc/proxychains.conf ];then
        $SUDO sed -i 's/^socks4.*/socks5 127.0.0.1 7070/g' /etc/proxychains.conf 
    fi
}
...
_setup_iptables()
{
    if [ -e $zm_user_dir/iptables.rules ];then
        $SUDO cp -fv $zm_user_dir/iptables.rules /etc/iptables/iptables.rules
    fi
}
