...
_add_softs_common()
{
    ...
    #add_soft imagemagick 
    add_soft feh gpicview geeqie #pinta
    ...
    add_soft poppler-data apvlv impressive
    ...
    add_soft fonts-wqy-microhei fonts-wqy-zenhei xfonts-wqy 
    ...
    add_soft python-paramiko python-serial 
    ...
    add_soft bridge-utils uml-utilities
    ...
    #for mono develop
    #add_soft mono-complete monodevelop
    #add_soft mono-xsp mono-xsp2 mono-xsp2-base mono-xsp4 mono-xsp4-base
    ...
    add_soft libgl1-mesa-dri libglapi-mesa libgles2-mesa libglu1-mesa
...
_setup_font()
{
    local fontconfigdir=$(echo eval ~$zm_user)/.config/fontconfig/
